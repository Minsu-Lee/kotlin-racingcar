...
class GameContext(
    ...
    constructor(inputView: InputView, resultView: ResultView) : this(inputView, resultView, CarFactory, EngineFactory)

    fun createCars(carNames: List<String>): List<Car> {
        return carFactory.createCars(carNames, engineFactory::create)
    }
}
